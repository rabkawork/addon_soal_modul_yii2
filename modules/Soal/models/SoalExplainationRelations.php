...
/**
 * This is the model class for table "soal_explaination_relations".
 *
 * @property int $id
 ...
 * @property int $hidden
 */
class SoalExplainationRelations extends \yii\db\ActiveRecord
{
    ...
    {
        return 'soal_explaination_relations';
    }
